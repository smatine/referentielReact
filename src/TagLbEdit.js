...
class TagLbEdit extends Component {
  ...
  async handleSubmit(event) {
    ...
    await fetch((item.id) ? '/lbs/' + (item.lb.id) + '/tags/'+(item.id) : '/lbs/' + item.lb.id + '/tags', {
...
export default withRouter(TagLbEdit);