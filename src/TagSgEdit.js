...
class TagSgEdit extends Component {
  ...
  async handleSubmit(event) {
    ...
    await fetch((item.id) ? '/sgs/' + (item.sg.id) + '/tags/'+(item.id) : '/sgs/' + item.sg.id + '/tags', {
...
export default withRouter(TagSgEdit);